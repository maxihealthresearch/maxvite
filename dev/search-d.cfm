...
<ul class="js-checkbox-list checkbox-list filter-module-main">
{{#each brands}}
...
<div class="filter-module filter-module-price" data-module="specials">
<ul class="filter-module-title">
  <li>Price</li>
  <li class="filter-module-toggler">Show/Hide</li>
  <li class="filter-module-clear {{#unless specials_selected}}hidden{{/unless}}"><a href="clear">Clear</a></li>
</ul>
	<div class="filter-module-main">
	<p>Set custom price range:</p>
	<ul class="filter-module-price-form">
	<li>$</li>
	<li><input type="text" size="3" class="qtyInput" maxlength="4" value="{{min_price}}" name="qtytoadd"></li>
	<li>to&nbsp;$</li>
	<li><input type="text" size="3" class="qtyInput" maxlength="4" value="{{max_price}}" name="qtytoadd"></li>
	<li><a href="price-range" class="btn">GO</a></li>
	</ul>
	</div>
</div>
